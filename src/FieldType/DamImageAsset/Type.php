...
namespace App\FieldType\DamImageAsset;
...
{
    const FIELD_TYPE_IDENTIFIER = 'ezdamimageasset';
    ...
    /** @var \App\FieldType\DamImageAsset\AssetMapper */
    private $assetMapper;
    ...
    public function fromHash($hash): Value
    {
        ...
        if ($destinationContentId !== null && !isset($hash['source'])) {
            $destinationContentId = (int)$destinationContentId;

            return new Value($destinationContentId, $hash['alternativeText']);
        }

        return new Value($destinationContentId, $hash['alternativeText'], $hash['source']);
    }
    ...
    public function toHash(SPIValue $value): array
    {
        ...
        if ($value->destinationContentId !== null && !isset($value->source)) {
    ...
    {
        $relations = [];
        if ($fieldValue->destinationContentId !== null && !isset($fieldValue->source)) {
