...
use App\Form\Type\DamAssetType;
...
class DamImageAssetFieldType extends AbstractType
{
    ...
    {
        return 'ezplatform_fieldtype_ezdamimageasset';
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('damAsset', DamAssetType::class)
            ->add(
                'remove',
                CheckboxType::class,
                [
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        if ($view->vars['value']['destinationContentId'] && is_int($view->vars['value']['destinationContentId'])) {
            try {
