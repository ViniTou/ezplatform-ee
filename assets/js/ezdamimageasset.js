(function(global, doc, eZ, React, ReactDOM, Translator, Routing) {
    const SELECTOR_FIELD = '.ez-field-edit--ezdamimageasset';
    ...
    class EzDamImageAssetPreviewField extends eZ.BasePreviewField {
        /**
    ...
    doc.querySelectorAll(SELECTOR_FIELD).forEach((fieldContainer) => {
        ...
        const previewField = new EzDamImageAssetPreviewField({
            validator,
            fieldContainer,
